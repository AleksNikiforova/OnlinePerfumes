...
namespace OnlinePerfumes.DataAccess.Migrations
{
    ...
    [Migration("20250307061708_ChangeShippingAddress")]
    partial class ChangeShippingAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlinePerfumes.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlinePerfumes.Models.CartItem", b =>
                {
                    b.HasOne("OnlinePerfumes.Models.Customer", "Customer")
                        .WithMany("CartItems")
